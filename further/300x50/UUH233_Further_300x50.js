...
lib.ssMetadata = [
		{name:"UUH233_Further_300x50_atlas_P_1", frames: [[0,0,600,100]]}
];
...
(lib.logo_300x50 = function() {
	this.initialize(ss["UUH233_Further_300x50_atlas_P_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UUH233_Further_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UUH233_Further_300x50_atlas_P_1.png?1632947183023", id:"UUH233_Further_300x50_atlas_P_1"}
	],
	preloads: []
};
